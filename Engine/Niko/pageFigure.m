...
if ~exist('paperSizeORheightToWidth')||isempty(paperSizeORheightToWidth), paperSizeORheightToWidth='letter'; end
%if ~exist('proportionOfScreenArea')||isempty(proportionOfScreenArea), proportionOfScreenArea=0.23; end
if ~exist('proportionOfScreenArea')||isempty(proportionOfScreenArea), proportionOfScreenArea=.35; end
