...
%
% Will generate a text-labelled MDS plot for each RDM in RDMs.
%
%        RDMs --- A struct of RDMs.
%                All RDMs in here will be concatenated and have their condition
%                MDSs figured.
%
...
%                        condition for display on figures.
...
if isfield(userOptions, 'dotSize'), MDSOptions.dotSize = userOptions.dotSize; end%if
...
for RDMi = 1:nRDMs
	...
	veryLocalOptions.figI_textLabels = [thisFigureNumber 1 2 1];
	veryLocalOptions.figI_shepardPlots = [thisFigureNumber 1 2 2];
