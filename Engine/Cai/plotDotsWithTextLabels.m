function plotDotsWithTextLables(coords_xy, localOptions)
...
if isfield(localOptions, 'categoryColumns')
    ...
    for itemI=1:nItems        
        text(coords_xy(itemI,1) + (localOptions.dotSize*0.2)/100,coords_xy(itemI,2) - (localOptions.dotSize*0.6)/100,...
            localOptions.textLabels{itemI},'Color','k','FontSize',localOptions.fontSize,'HorizontalAlignment','Center'); % added shift in text labels IZ 05/13
	end%for:itemI
