...
for m = 1:2:nMasks    
    masked_lh.data = masking(lh.data,indexMasks,m);
    masked_rh.data = masking(rh.data,indexMasks,m+1);
...
%     end
    ...
    masked_lh.data = masking(lh.data,indexMasks,21) + masking(lh.data,indexMasks,23) +masking(lh.data,indexMasks,25) ;
    masked_rh.data = masking(rh.data,indexMasks,22) + masking(rh.data,indexMasks,24) +masking(rh.data,indexMasks,26) ;
